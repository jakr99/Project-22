...
accept_file = open("unit_tests/inputs/1_9d_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_9d_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_9d import prob_1_9d
test_machine = prob_1_9d
