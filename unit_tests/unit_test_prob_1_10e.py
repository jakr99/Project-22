...
accept_file = open("unit_tests/inputs/1_10e_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_10e_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_10e import prob_1_10e
test_machine = prob_1_10e
