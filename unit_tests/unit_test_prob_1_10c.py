...
accept_file = open("unit_tests/inputs/1_10c_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_10c_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_10c import prob_1_10c
test_machine = prob_1_10c
