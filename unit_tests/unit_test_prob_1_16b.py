...
accept_file = open("unit_tests/inputs/1_16b_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_16b_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_16b import prob_1_16b
test_machine = prob_1_16b
