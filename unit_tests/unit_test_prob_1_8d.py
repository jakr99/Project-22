...
accept_file = open("unit_tests/inputs/1_8d_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_8d_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_8d import prob_1_8d
test_machine = prob_1_8d
