...
accept_file = open("unit_tests/inputs/1_8c_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_8c_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_8c import prob_1_8c
test_machine = prob_1_8c
