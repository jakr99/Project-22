...
accept_file = open("unit_tests/inputs/1_17b_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_17b_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_17b import prob_1_17b
test_machine = prob_1_17b
