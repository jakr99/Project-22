...
accept_file = open("unit_tests/inputs/1_9c_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_9c_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_9c import prob_1_9c
test_machine = prob_1_9c
