...
accept_file = open("unit_tests/inputs/1_16a_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_16a_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_16a import prob_1_16a
test_machine = prob_1_16a
