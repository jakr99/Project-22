...
accept_file = open("unit_tests/inputs/1_10d_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_10d_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_10d import prob_1_10d
test_machine = prob_1_10d
