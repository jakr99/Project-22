...
accept_file = open("unit_tests/inputs/1_17a_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_17a_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_17a import prob_1_17a
test_machine = prob_1_17a
